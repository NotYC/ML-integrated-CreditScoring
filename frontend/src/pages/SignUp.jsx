    ...
    <div className="min-h-screen w-full flex">
      <div className="w-full md:w-1/2 bg-white text-black flex items-center justify-center p-8">
        <div className="w-full max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex gap-4">
              <input name="firstName" placeholder="First name" onChange={handleChange} required className="flex-1 border border-gray-300 p-2 rounded" />
              <input name="lastName" placeholder="Last name" onChange={handleChange} required className="flex-1 border border-gray-300 p-2 rounded" />
            </div>
            <input name="address" placeholder="Address" onChange={handleChange} required className="w-full border border-gray-300 p-2 rounded" />
            <input name="city" placeholder="City" onChange={handleChange} required className="w-full border border-gray-300 p-2 rounded" />
            <div className="flex gap-4">
              <input name="state" placeholder="State" onChange={handleChange} required className="flex-1 border border-gray-300 p-2 rounded" />
              <input name="postalCode" placeholder="Postal Code" onChange={handleChange} required className="flex-1 border border-gray-300 p-2 rounded" />
            </div>
            <div className="flex gap-4">
              <input name="dob" type="date" onChange={handleChange} required className="flex-1 border border-gray-300 p-2 rounded" />
              <input name="uid" placeholder="UID" onChange={handleChange} required className="flex-1 border border-gray-300 p-2 rounded" />
            </div>
            <input name="email" type="email" placeholder="Email" onChange={handleChange} required className="w-full border border-gray-300 p-2 rounded" />
            <input name="password" type="password" placeholder="Password" onChange={handleChange} required className="w-full border border-gray-300 p-2 rounded" />
          ...
          <p className="mt-4 text-center text-gray-600">
            Already have an account?{' '}
            <Link to="/signin" className="text-blue-500 hover:text-blue-400">Sign in</Link>
          </p>
        </div>
      </div>
